...
public enum SpeakingStageEnum {
    ...
    SpeakingStageEnum(String code, String desc, String languageCode) {
        this.code = code;
        this.desc = desc;
    ...
    @JsonCreator
    public static SpeakingStageEnum fromCode(String code) {
        for (SpeakingStageEnum e : values()) {
            if (e.code.equals(code)) {
                return e;
            }
        }
        throw new BusinessException(ResultCodeEnum.PARAM_ERROR, "不支持的口语学习阶段: " + code);
    }
}
