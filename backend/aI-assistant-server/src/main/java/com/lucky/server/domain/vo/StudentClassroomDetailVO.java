 ...
 */
@Schema(description = "学生课堂详情")
public record StudentClassroomDetailVO(
        ...
        @Schema(description = "课堂说明，存储富文本HTML内容") String description,
        ...
        @Schema(description = "课堂创建时间") LocalDateTime createTime,
