 ...
 */
@Data
@TableName("speaking_material_generation")
@Schema(name = "SpeakingMaterialGeneration", description = "口语素材生成记录")
public class SpeakingMaterialGeneration implements Serializable {
