 ...
 */
public enum CompositionStageEnum {
...
//    EN_TOEFL("en_toefl", "托福", "english");
    ...
    CompositionStageEnum(String code, String desc, String languageCode) {
        this.code = code;
        this.desc = desc;
    ...
    @JsonCreator
    public static CompositionStageEnum fromCode(String code) {
        for (CompositionStageEnum e : values()) {
            if (e.code.equals(code)) {
                return e;
            }
        }
        throw new BusinessException(ResultCodeEnum.PARAM_ERROR, "不支持的写作学习阶段: " + code);
    }
}