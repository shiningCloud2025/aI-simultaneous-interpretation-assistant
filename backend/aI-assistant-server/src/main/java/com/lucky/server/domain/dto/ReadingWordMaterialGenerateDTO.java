...
public record ReadingWordMaterialGenerateDTO(
        @Schema(description = "单词/词语") @NotBlank(message = "单词不能为空") String word,
        @Schema(description = "语言编码") @NotNull(message = "语言不能为空") ReadingLanguageEnum languageCode,
        @Schema(description = "学习阶段编码") @NotNull(message = "学习阶段不能为空") ReadingStageEnum stageCode
) {
}
